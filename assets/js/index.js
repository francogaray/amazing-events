...
function indexInitializer() {
    ...
    // Crear checkboxs de las categrías
        ...
        return categories
            ...
            <div>
                <input class="form-check-input" type="checkbox" name="category${
                    index + 1
                }" id="category${index + 1}" value="${category}">
    ...
    // Filtro de eventos cruzado (por categorías y por nombre)
        ...
        if (searchParams.value !== "") {
            cardsFiltered = cardsFiltered.filter(function (event) {
                return (
                    event.name
                        .toLowerCase()
                        .indexOf(searchParams.trim().toLowerCase()) !== -1
                );
            });
        }
